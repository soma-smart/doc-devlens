...
5. `SPARK TABLE ENV`: Identifies 'spark.table()' references in Python code.

### SparkSQL 

1. `ENV VAR IN TABLE NAME`: Identifies environment variables in table names within Spark SQL queries.
